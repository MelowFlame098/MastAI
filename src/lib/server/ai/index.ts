...
export function available(): string | null {
	if (env.OPENAI_API_KEY) {
		return `Smart Assistant (Advanced Model)`;
	}

	if (env.AI) {
		return `Smart Assistant (Standard Model)`;
	}
