...
type RouteParams = { database: string };
type RouteId = '/db/[database]';
...
type LayoutRouteId = RouteId | "/db/[database]" | "/db/[database]/[table]"
type LayoutParams = RouteParams & { database?: string; table?: string }
