...
type LayoutRouteId = RouteId | "/" | "/admin" | "/db" | "/db/[database]" | "/db/[database]/[table]" | "/login" | "/themes" | "/themes/enhanced" | "/themes/[theme]" | null
type LayoutParams = RouteParams & { database?: string; table?: string; theme?: string }
